...
from sqlalchemy import Column, VARCHAR, INTEGER, FLOAT, Enum
...
class UnpaidRewards(Base):
	...
	@staticmethod
	async def remove(account_id: str, action: ActionEnum):
	...
	@staticmethod
	async def get_unpaid_action_types() -> list['UnpaidRewards']:
