...
def sign_delete_access_key_tx(
        signer_key: signer.Signer,
        target_account_id: str,
        key_for_deletion: str,
        nonce: int,
        block_hash: bytes,
) -> bytes:
...
def sign_payment_tx(
    ...
    return sign_and_serialize_transaction(receiver_id, nonce, [action], block_hash, key.account_id)
